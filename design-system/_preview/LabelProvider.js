...
var __dsPreview = (() => {
        ...
        var _ = (function() {
          ...
          return m2.parse = function(t2) {
            ...
            switch (f2) {
              ...
              case o:
                var g6 = this.$locale().weekStart || 0, D2 = (y2 < g6 ? y2 + 7 : y2) - g6;
            ...
            var $2, y2 = this, M3 = b.p(d2), m3 = O(r2), v2 = (m3.utcOffset() - this.utcOffset()) * e, g6 = this - m3, D2 = function() {
              return b.m(y2, m3);
            };
            switch (M3) {
              case h:
  ...
  // .design-sync/.cache/previews/LabelProvider.tsx
  var LabelProvider_exports = {};
  __export(LabelProvider_exports, {
    Default: () => Default2
  });
  init_define_import_meta_env();
  init_define_process_env();
  ...
  var label_provider_stories_exports = {};
  __export(label_provider_stories_exports, {
    Default: () => Default,
    default: () => label_provider_stories_default
  });
  init_define_import_meta_env();
  init_define_process_env();
  ...
  var g4 = window.Tedi;
  var ds_default = "default" in g4 ? g4.default : g4;

  // src/tedi/providers/label-provider/label-provider.stories.tsx
  var import_jsx_runtime2 = __toESM(require_react_shim());
  var label_provider_stories_default = {
    title: "TEDI-Ready/Providers/LabelProvider",
    component: ds_LabelProvider_default,
    decorators: [
      (Story, options) => {
  ...
  var Template = () => {
    const { getLabel } = (0, ds_exports.useLabels)();
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { children: [
        getLabel("close"),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_Text_exports.Text, { color: "secondary", modifiers: "small", element: "span", children: "(Custom label provided by Application)" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: getLabel("pagination.results", 1) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: getLabel("pagination.results", 4) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { children: [
        getLabel("missing.label"),
        " -",
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_Text_exports.Text, { color: "secondary", modifiers: "small", element: "span", children: "(Error in console that label is missing for key: missing.label)" })
      ] })
    ] });
  };
  var Default = {
  ...
  var Default2 = (
    /* Default */
    compose(label_provider_stories_exports, "Default")
  );
  return __toCommonJS(LabelProvider_exports);
})();
