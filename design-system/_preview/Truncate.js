...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/Truncate.tsx
  var Truncate_exports = {};
  __export(Truncate_exports, {
    Default: () => Default2,
    NoTruncate: () => NoTruncate2
  });
  init_define_import_meta_env();
  init_define_process_env();
  var React = __toESM(require_react_shim(), 1);

  // src/tedi/components/content/truncate/truncate.stories.tsx
  var truncate_stories_exports = {};
  __export(truncate_stories_exports, {
    Default: () => Default,
    NoTruncate: () => NoTruncate,
    default: () => truncate_stories_default
  });
  init_define_import_meta_env();
  init_define_process_env();
  ...
  var g3 = window.Tedi;
  var ds_Truncate_default = g3["Truncate"] !== void 0 ? g3["Truncate"] : g3;

  // src/tedi/components/content/truncate/truncate.stories.tsx
  var import_jsx_runtime = __toESM(require_react_shim());
  var meta = {
    component: ds_Truncate_exports.Truncate,
  ...
  var truncate_stories_default = meta;
  var TemplateColumn = (args) => {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(grid_exports.Row, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(grid_exports.Col, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_Truncate_exports.Truncate, { ...args }) }) });
  };
  var Default = {
  ...
  var Default2 = (
    /* Default */
    compose(truncate_stories_exports, "Default")
  );
  var NoTruncate2 = (
    /* No Truncate */
    compose(truncate_stories_exports, "NoTruncate")
  );
  return __toCommonJS(Truncate_exports);
})();
