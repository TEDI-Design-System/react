...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/Print.tsx
  var Print_exports = {};
  ...
  // src/tedi/components/misc/print/print.stories.tsx
  var print_stories_exports = {};
  __export(print_stories_exports, {
    Default: () => Default,
    default: () => print_stories_default
  });
  init_define_import_meta_env();
  init_define_process_env();
  ...
  var meta = {
    component: ds_Print_exports.Print,
  ...
  var print_stories_default = meta;
  var Template = (args) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ds_VerticalSpacing_exports.VerticalSpacing, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_Print_exports.Print, { ...args, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Demo paragraph" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_Print_exports.Print, { ...args, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_Button_default, { children: "Buttons are not printed by default" }) })
  ] });
  var Default = {
    render: Template
  };
  ...
  var Default2 = (
    /* Default */
    compose(print_stories_exports, "Default")
  );
