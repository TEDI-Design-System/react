...
/**
 * InfoButton — from @tedi-design-system/react@0.0.0-semantic-version (./src/tedi/components/buttons/info-button/info-button.stories.tsx).
 */
...
export declare const InfoButton: React.ComponentType<InfoButtonProps>;
