 ...
 * <a href="https://www.tedi.ee/1ee8444b7/p/94a0cb-map-info" target="_BLANK">ZeroHeight ↗</a>
 */

const meta: Meta<typeof MapInfo> = {
  component: MapInfo,
  title: 'Community/Map components/MapInfo',
};

export default meta;
type Story = StoryObj<typeof MapInfo>;
