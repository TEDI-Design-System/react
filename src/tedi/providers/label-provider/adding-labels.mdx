...
```tsx
import { validateLabelValues } from '@tedi-design-system/react/tedi';
...
declare module '@tedi-design-system/react/tedi' {
...
```tsx
import { validateLabelRecord, TediLanguage } from '@tedi-design-system/react/tedi';
