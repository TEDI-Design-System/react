...
export const labelsMap = validateDefaultLabels({
  ...
  'header.role-selection.search-label': {
    description: 'Label for Search in Role selection (Person)',
    components: ['HeaderRole'],
    et: 'Otsi isikut',
    en: 'Search representative',
    ru: 'Найти представителя',
  },
  'header.role-selection.search-label-organization': {
    description: 'Label for Search in Role selection (Organization)',
    components: ['HeaderRole'],
    et: 'Otsi asutust',
    en: 'Search representative',
    ru: 'Найти представителя',
