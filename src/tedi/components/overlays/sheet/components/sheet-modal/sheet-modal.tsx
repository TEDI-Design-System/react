...
import styles from './sheet-modal.module.scss';

interface SheetModalBaseProps {
...
export type SheetModalProps = SheetModalBaseProps &
  (
    | {
        /**
 ...
 * need a sheet (e.g. `TableOfContents.Collapsible`, `CardStepper`) until they
 * migrate to the public compound `Sheet`.
 */
