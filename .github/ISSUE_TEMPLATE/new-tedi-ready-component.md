...
- [ ] External libraries **comply with [validated open source licenses](https://github.com/TEHIK-EE/tedi-design-system/wiki/Definition-of-Done#validated-open-source-component-licences)**
- [ ] Component is versioned correctly and ready for release if required
- [ ] Update [statuses page in Zeroheight](https://www.tedi.ee/1ee8444b7/p/300e17-komponentide-staatused)
